...
public class TweedeKamer {
	...
	private void vraagAanBode() {
		int i = 0;
		Bode b;
		while (++i<2) {
			b = Data.getRandomBodes();
			System.out.println(b.StelVriendelijkeVraag());
		}
	}
	...
	private void toonKeuzeMenu() {
		...
		System.out.println("  4. vraag de Bode om een bak koffie");
